...
public class Utils {
   ...
   public static String[] getNextLine(String lines) {
      // "notifier",-1: value return by the class method String.indexOf() 
      // if the char doesn't occur
      final int UNFOUND = -1;
      String res[] = new String[2];
      // init of the two strings contained in the string's array
      res[0] = "";
      res[1] = "";
      ...
      // if no new line characters are found, affect the lines and do nothing 
      // for the separator
      if (pos == UNFOUND) {
         res[1] = lines;
         return res;
