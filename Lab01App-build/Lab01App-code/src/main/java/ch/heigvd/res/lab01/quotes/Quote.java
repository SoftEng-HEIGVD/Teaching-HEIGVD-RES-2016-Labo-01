...
public class Quote implements Serializable {
     ...
     * "iheartquotes". The API was sending us a list of tags with every quote.
     * We don't have this from the Chuck Norris facts API, so we generate random
     * tags to have the data available.
     */
    private String[] tags;
    ...
    /**
     * In the 2015 version of the lab, we were getting quotes with multiple
     * lines. This is important if we want to see one feature of the lab in
     * action (line numbering). The Chuck Norris API sends us one-line jokes, so
     * we have added some code to split the jokes in multiple lines (one space
     * out of three is replaced by a new line character)
     */
