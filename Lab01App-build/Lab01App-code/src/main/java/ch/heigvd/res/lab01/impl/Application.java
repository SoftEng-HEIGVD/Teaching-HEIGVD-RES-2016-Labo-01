...
public class Application implements IApplication {
   ...
   void storeQuote(Quote quote, String filename) throws IOException {
      ...
      // generates the path according to tags of quote
      for (String tag : quote.getTags()) {
         path += "/" + tag;
      }

      // creates abstract file directory
      File file = new File(path);
      // generates directories of the file
      file.mkdirs();

      // creates and writes in the real file system
   ...
   void printFileNames(final Writer writer) {
      ...
      explorer.explore(new File(WORKSPACE_DIRECTORY), new IFileVisitor() {
         ...
         public void visit(File file) {
            /*
             * Notice how we use an anonymous class here. We provide the implementation
   ...
   public String getAuthorEmail() {
      return "jeremie.zanone@heig-vd.ch";
   }
