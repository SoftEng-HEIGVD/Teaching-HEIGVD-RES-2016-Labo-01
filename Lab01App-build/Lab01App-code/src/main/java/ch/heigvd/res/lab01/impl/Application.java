...
/**
 * Retrieve and store quotes from the server into the workspace directory.
 * 
...
public class Application implements IApplication {
    ...
    /**
     * Fetch quotes from the server, logs it and store it in the workspace directory
     * 
    ...
    /**
     * Create the output file for every quote stored in the workspace directory
     * 
     * @throws IOException 
     */
    @Override
