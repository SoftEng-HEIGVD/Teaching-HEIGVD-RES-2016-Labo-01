...
public class Application implements IApplication {
     ...
     */
       ...
       */
            Writer writer = new StringWriter(); // we create a special writer that will send characters into a string
            // (memory)
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
             ...
             */
            String catPath = String.join(File.separator, quote.getTags());
            String filePath = String.format("quote-%d.utf8", quote.getValue().getId());
            storeQuote(quote, String.join(File.separator, WORKSPACE_DIRECTORY, catPath, filePath));
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        Files.write(file, quote.getQuote().getBytes());
    }
    ...
    public String getAuthorEmail() {
        return "jeremy.david@heig-vd.ch";
    }
