...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        //write the file frome the quote
        OutputStreamWriter oStream = new OutputStreamWriter(new FileOutputStream(file), Charset.forName("UTF-8"));
        oStream.write(quote.getQuote());        
        oStream.close();
    }
    ...
    public String getAuthorEmail() {
        return "remi.jacquemard@heig-vd.ch";
    }
