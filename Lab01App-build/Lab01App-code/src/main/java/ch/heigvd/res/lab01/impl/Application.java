...
public class Application implements IApplication
{
	...
	void storeQuote(Quote quote, String filename) throws IOException
	{
		...
		File actualFile = new File(currentDirectory, filename);
		actualFile.createNewFile();

		// Stores the quote text
		Writer writer = new OutputStreamWriter(new FileOutputStream(actualFile), "UTF-8");
	...
	{
		return "thibaud.besseau@heig-vd.ch";
	}
