...
public class Application implements IApplication {
   ...
   * @throws IOException 
   */
  void storeQuote(Quote quote, String filename) throws IOException {//throw new UnsupportedOperationException("The student has not implemented this method yet.");
  ...
  public String getAuthorEmail() {
     return "christophe.peretti@heig-vd.ch";
  }
