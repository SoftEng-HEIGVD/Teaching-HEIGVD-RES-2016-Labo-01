...
public class Application implements IApplication {
  ...
  void storeQuote(Quote quote, String filename) throws IOException {
      List<String> tags = quote.getTags();  // We get the tags of the quote to create the sub directories.
      String quotePath = WORKSPACE_DIRECTORY + '/';

      // We add each sub directory in the path.
      for (String tag : tags) {
       quotePath += tag + '/';
      }

      // Create all sub directories.
      File dir = new File(quotePath);
      dir.mkdirs();
