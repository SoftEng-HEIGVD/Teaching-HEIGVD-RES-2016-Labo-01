...
public class Application implements IApplication {
  ...
  void storeQuote(Quote quote, String filename) throws IOException {
    //throw new UnsupportedOperationException("The student has not implemented this method yet (storeQuote).");
    List<String> tags = new ArrayList<String>();
    tags = quote.getTags();
    String path = new String("workspace" + File.separator + "quotes" + File.separator);
    for(String tag : tags) {
  ...
  public String getAuthorEmail() {
    return "ludovic.richard@heig-vd.ch";


    //throw new UnsupportedOperationException("The student has not implemented this method yet (getAuthorEmail).");
  }
