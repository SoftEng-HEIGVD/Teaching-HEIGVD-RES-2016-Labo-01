...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        //store quote into file   
        File fileText = new File(path + filename);
        Writer output = new OutputStreamWriter(new FileOutputStream(fileText), "UTF-8");
        ...
        explorer.explore(new File(WORKSPACE_DIRECTORY), new IFileVisitor() {
            ...
            public void visit(File file) {
                try {
                    ...
                    LOG.log(Level.SEVERE, "Could not print the name of each encountered file and directory.. {0}", except.getMessage());
    ...
    public String getAuthorEmail() {
        return "hyacinthe.kamenitchieko@heig-vd.ch";
    }
