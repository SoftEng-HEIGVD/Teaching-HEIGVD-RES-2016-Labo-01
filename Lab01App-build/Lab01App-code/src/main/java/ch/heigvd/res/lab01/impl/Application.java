...
public class Application implements IApplication {
  ...
  void storeQuote(Quote quote, String filename) throws IOException {
    List<String> myTabStr = quote.getTags();
    String myStr = WORKSPACE_DIRECTORY;

    for (String str: myTabStr) {
      myStr += "/" + str;
    }

    File myFile = new File(myStr);
    myFile.mkdirs();

    OutputStreamWriter myOutputStream = new FileWriter(myStr + "/" + filename);
  ...
  public String getAuthorEmail() {
    return "Madolyne.Dupraz@heig-vd.ch";
  }
