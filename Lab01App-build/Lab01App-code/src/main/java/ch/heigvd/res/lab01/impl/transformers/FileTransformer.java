...
public abstract class FileTransformer implements IFileVisitor {
  ...
  public void visit(File file) {
    ...
    try {
       ...
       */
       int caracterStream = reader.read();
       // If this source of characters is not at its end then we can read it and write it to the writer
       while (caracterStream != -1) {
          writer.write(caracterStream);
          caracterStream = reader.read();
       }
