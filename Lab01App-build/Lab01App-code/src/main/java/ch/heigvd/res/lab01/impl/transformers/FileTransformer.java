...
public abstract class FileTransformer implements IFileVisitor {
    ...
    * method creates an output file and creates a corresponding writer. It then calls
    * decorateWithFilters and passes the writer as argument. The method wraps 0, 1 or
    * more filter writers around the original writer and returns the result.
    *
   ...
   public void visit(File file) {
      ...
      try {
         ...
         /*
          * You have an input reader and an ouput writer (notice how the 
          * writer has been decorated by the concrete subclass!). You need to write a loop to read the
          * characters and write them to the writer.
          */
         int c;

         // as long as there is something to read then written
